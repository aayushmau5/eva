defmodule Eva.Agent.Utils do
  ...
  Built from `:crypto` rather than a library: this module travels into every extension
  build, and a dependency here is one an extension author can collide with and cannot
  resolve — the BEAM holds a single version of a module at a time.
  """
