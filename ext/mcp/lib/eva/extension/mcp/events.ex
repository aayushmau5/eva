defmodule Eva.Extension.MCP.Events do
  @moduledoc """
  ...
  typedstruct module: ServerConnected do
    ...
    field :scope_dir, Eva.Extension.MCP.Events.scope_dir()
  ...
  typedstruct module: ToolsDiscovered do
    ...
    field :server_name, String.t()
    field :scope_dir, Eva.Extension.MCP.Events.scope_dir()
    field :tools, [Eva.Extension.MCP.Events.tool()], default: []
  end
  ...
  typedstruct module: ToolsChanged do
    ...
    field :scope_dir, Eva.Extension.MCP.Events.scope_dir()
    field :tools, [Eva.Extension.MCP.Events.tool()], default: []
    field :added, [Eva.Extension.MCP.Events.tool()], default: []
  ...
  typedstruct module: ResourcesDiscovered do
    ...
    field :server_name, String.t()
    field :scope_dir, Eva.Extension.MCP.Events.scope_dir()
    field :resources, [Eva.Extension.MCP.Events.resource()], default: []
    field :templates, [Eva.Extension.MCP.Events.resource_template()], default: []
  end
  ...
  typedstruct module: PromptsDiscovered do
    ...
    field :server_name, String.t()
    field :scope_dir, Eva.Extension.MCP.Events.scope_dir()
    field :prompts, [Eva.Extension.MCP.Events.prompt()], default: []
  end
  ...
  the list: `@mcp_events Eva.Extension.MCP.Events.modules()`, then
